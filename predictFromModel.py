...
from data_ingestion import data_loader_predict
from app_logging.logger import app_logger
from prediction_raw_data_validation.predict_raw_data_validation import Prediction_Data_Validation

class Prediction:
    def __init__(self,path):
        self.file_object = open("PredictionLogs/Prediction_Log.txt", 'a+')
    ...
    def predictionFromModel(self):
        ...
        try:
            ...
            data_getter=data_loader_predict.Data_Getter_Pred(self.file_object,self.log_writer)
            ...
            for i in clusters:
                ...
                model_name = file_loader.find_correct_model(i)
