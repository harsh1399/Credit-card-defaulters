...
class Clustering:
    ...
    # creates elblow plot to decide the optimum number of clusters
    ...
    # returns the cluster for each row of data
    def create_clusters(self,data,number_of_clusters):
        ...
        try:
            ...
            file_op = file_methods.File_Operations(self.file_object, self.logger_object)
