...
class Raw_Data_Validation:
    ...
    #extracts all the information from schema
    ...
    # manually defined regex based on the filename
    def manualRegexCreation(self):
        # sample file name: "creditCardFraud_021119920_010222.csv"
        regex = "['creditCardFraud']+['\_'']+[\d_]+[\d]+\.csv"
        return regex

    #creates directory for storing good/bad raw data after validation
    ...
    # deletes good raw data directory
    ...
    def validateMissingValuesInWholeColumn(self):
        try:
            f = open("TrainingLogs/missingValuesInColumn.txt", 'a+')
